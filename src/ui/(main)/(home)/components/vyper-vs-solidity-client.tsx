...
import snekNightclub from '../assets/sneks/nightclub-01.png'
  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-28">
      <MaxWidthWrapper className="relative">
        <div
          aria-hidden
          className="pointer-events-none absolute -top-20 left-0 -z-10 w-36 opacity-15 sm:w-48 md:w-60 md:opacity-20 lg:w-80"
        >
          <Image
            src={snekNightclub}
            alt=""
